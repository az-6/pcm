...
use Database\Factories\FundSubmissionFactory;
...
{
    /** @use HasFactory<FundSubmissionFactory> */
    use HasFactory;
    ...
    {
        return ['status' => SubmissionStatus::class, 'amount' => 'decimal:2', 'submitted_at' => 'datetime', 'reviewed_at' => 'datetime'];
    }
    ...
    {
        return $this->hasMany(FundSubmissionItem::class);
    }
