...
class WorkProgram extends Model
{
    ...
    public function majelis(): BelongsTo { return $this->belongsTo(Majelis::class); }

    /** @return BelongsTo<User, $this> */
    public function creator(): BelongsTo { return $this->belongsTo(User::class, 'created_by'); }

    /** @return HasMany<FundSubmission, $this> */
    public function submissions(): HasMany { return $this->hasMany(FundSubmission::class); }

    /** @return HasMany<ProgramReport, $this> */
    public function reports(): HasMany { return $this->hasMany(ProgramReport::class); }
}
